...
const Info = () => {
    const data = {
        ...
        p1: "Amongst the most prevalent problems today that many people deal with is acne. It is a bothersome problem that also causes acne scars. Scars from acne can be difficult to remove. They detract from a person's facial attractiveness and may lower their self-confidence. Skinroots provides several methods for treating acne scars. Acne Scar Treatments are tailored to each patient's individual needs.",
