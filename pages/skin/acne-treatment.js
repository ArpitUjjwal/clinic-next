...
const Info = () => {
    const data = {
        ...
        p2: "Acne is a condition that cannot be cured but the condition can be treated successfully. Best Acne Treatment provided by Dermaiims Clinic, helps in treating the acne affected area though there is no permanent cure for Acne. This is because Acne is a physiological condition and not a mere disease. Sometimes, the underlying cause of acne might be genetic and therefore finding a cure might not be easy.Lifestyle and your diet, though do not directly cause Acne, these factors can certainly exaggerate the issue, if not controlled timely. Consulting the Best Acne Treatment in Delhi would help you get the best treatment from the best skin experts. Further, the skin experts would also guide you about the diet and lifestyle you should practise to avoid the proliferation of Acne.",
        image: "/images/skin/skin1.jpg",
        p3: "There are specific combinations and drug specifications required to treat your acne and reduce its proliferation. It is advisable to book an appointment with Dermaiims Clinic – the Best Acne Treatment centre in Delhi, to get the personalised advice on use of such medication for the best results!Some specialised therapies used to treat Acne include:Chemical Peeling,Steroid Injection,Light Therapy,Drainage and Extraction Methods.These are highly professional therapies that should be done under expert supervision only. Connect with Dermaiims clinic today to get the best treatment and therapies today!"
    };
